...
let err = { status: 404, message: "Error" }
gis({ searchTerm: query + ' site:pt.pinterest.com', }, (er, res) => {
if (er) return err
let hasil = {
status: 200,
creator: 'chibot',
...
async function pinteres(querry) {
let hasil = []
await axios("https://pt.pinterest.com/search/pins/?rs=typed&q=" + querry, {
method: "GET",
headers: {
...
n = hasil.filter((i, l) => hasil.indexOf(i) == l)
return n
}

module.exports = { pinterest, pinteres }